...
jQuery(function($){
    ...
    /*
        ...
        This script makes use of the fullCalendar jQuery plugin.  
        Documentation avaliable at http://arshaw.com/fullcalendar

    */

    /*
        This array acts as a source for events - this is just an
        example for testing.  fullCalendar supports all sorts of feeds;
    ...
    */
    ...
    var calendarAPI,
        ...
        {
            title: 'event001',
            start: '2012-11-10 10:00:00',
            end: '2012-11-10 11:00:00',
            allDay: false
        },
        {
            title: 'event002',
            start: '2012-11-30 10:00:00',
            end: '2012-11-30 11:00:00',
            allDay: false
        },
        {
            title: 'event003',
            start: '2012-11-01 10:00:00',
            end: '2012-11-01 11:00:00',
            allDay: false
        }
    ];
    ...
    $('.mini-calendar').fullCalendar({
        ...
        //Set the images for the prev/next buttons here.
        ...
        //Change the format of the day names to match the design.
        ...
        /* 
            Add/remove class for "pressed" state.
        */
        
        dayClick: function(date, view) {            
            $('.fc-widget-content').removeClass('pressed');
        ...
        eventRender: function(event) {
            ...
            endTime = hour + ':' + minute + ' ' + measurement;
        }


    });// End mini-calendar functionality
